...
- [01_main-chapter-code](01_main-chapter-code) 包含主章节代码与练习解答

&nbsp;
## 补充材料

- [02_dataset-utilities](02_dataset-utilities) 包含可用于准备指令数据集的工具代码
- [03_model-evaluation](03_model-evaluation) 包含使用本地 Llama 3 模型与 GPT-4 API 评估指令响应的工具代码
- [04_preference-tuning-with-dpo](04_preference-tuning-with-dpo) 实现使用直接偏好优化（Direct Preference Optimization，DPO）进行偏好微调的代码
