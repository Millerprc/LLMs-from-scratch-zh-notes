...
本附加目录包含构建一个类似 ChatGPT 的 UI 与第 6 章微调后的垃圾邮件分类器进行交互的代码，如下所示。
...
[`app.py`](app.py) 文件包含 UI 相关代码。打开并查看这些文件以了解更多。

该文件会加载并使用我们在第 6 章生成的 GPT-2 分类器权重，因此你需要先执行 [`../01_main-chapter-code/ch06.ipynb`](../01_main-chapter-code/ch06.ipynb)。
